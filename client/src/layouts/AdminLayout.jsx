...
export default function AdminLayout() {
  ...
  const navigation = [
    ...
    { name: 'Categories', href: '/admin/categories', icon: TagIcon, current: location.pathname === '/admin/categories' },
    { name: 'Sections', href: '/admin/sections', icon: SquaresPlusIcon, current: location.pathname === '/admin/sections' },
    { name: 'Websites', href: '/admin/websites', icon: GlobeAltIcon, current: location.pathname === '/admin/websites' },
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                  <div className="flex h-16 shrink-0 items-center">
                    <h1 className="text-2xl font-bold text-primary-600">Section Builder</h1>
                  </div>
